         ...
         <div className="todos">
          ...
          return (showFinished || !item.isCompleted) && <div key={item.id} className={"todo flex my-3 justify-between"}>
            ...
            <div className="buttons flex h-full">
              ...
              <button onClick={(e)=>{handleDelete(e, item.id)}} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-sm font-bold text-white rounded-md mx-1'><FaTrashCan /> </button>
            </div> 
          </div>
          })}
         </div>
